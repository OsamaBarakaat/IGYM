        ...
        <form onSubmit={handleSubmit}>
          {days.map((day) => (
            <div key={day} className="day-container">
              ...
              <div className="flexcenterbetween midCol gap-2">
                <div className="w-100 flexcenterbetween gap-2">
                  <FloatingLabel
                    controlId={`peake-${day}-from`}
                    label={
                    ...
                    className="floating-label w-100"
                  >
                    <Form.Control
                      type="time"
