    ...
    <div className="myInfo">
      ...
      <div className="myInfoContent m-5">
        <div className="theme bigCard ">
          ...
          <div className="themeContent">
            ...
            <div className="flexcenteraround themeIcon">
              <div className="themeLogo logo-small object-fit-contain overflow-hidden">
            ...
            <div className="flexcenteraround themeIcon">
              <div className="themeLogo d-flex justify-content-center align-items-center logo-small overflow-hidden">
                <Form.Control
                  type="color"
              ...
              <div>
                <button className="textButtonTwo">
                  <div className="flexcenterbetween">
            ...
            >
              {gymInfo?.branchInfo.images.map((image, index) => (
                <SwiperSlide key={index} className="imgContRel">
                  <div className="" onClick={() => handleImageClick(image)}>
                    <img
                      src={image}
                      alt={`imagee-${index}`}
        ...
        <div className="bigCard socialLinks">
          ...
          <div className="websociallinks d-flex justify-content-around align-items-center">
            <a
            ...
            <a
              ...
              className="d-flex flex-column justify-content-center align-items-center text-decoration-none cursor-pointer"
              target="_blank"
            >
              <span>
                <svg
